...
@RestController
@RequestMapping("/api")
public class FarmerSalesReportController {

    private static final Logger logger = LoggerFactory.getLogger(FarmerSalesReportController.class);

    private final FarmerSalesReportService farmerSalesReportService;

    public FarmerSalesReportController(FarmerSalesReportService farmerSalesReportService) {
        this.farmerSalesReportService = farmerSalesReportService;
    }

    @PostMapping("/farmer-sales-report/data")
    public ResponseEntity<ApiResponse<List<Map<String, Object>>>> getReportData(@RequestBody Map<String, String> request) {
        ...
        try {
            ...
            List<Map<String, Object>> report = farmerSalesReportService.getFarmerSalesReport(
